     ...
     <div className="container">
      <div className="row">
        <div className="d-flex justify-content-between mt-5 pb-4">
          <h3 className='pb-0 mb-0'>Categories</h3>
...
<tr key={category.id}>
                            ...
                            <td>
                            {
                              category.status == 1 ? <span className="badge text-bg-success p-2"> Active </span>
                            ...
                            <td>
                               ...
                               <Link onClick={() => deleteCategories(category.id)} className='text-danger ms-2'>
