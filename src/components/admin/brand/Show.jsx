...
const Show = () => {
  ...
  const deleteBrands = async (id) => {
    if(confirm('Are you sure you want to delete')){
      ...
      const result = await res.json();
      if(result.status == 200){
        const newBrands = brands.filter(brands => brands.id != id);
        setBrands(newBrands);
                ...
                <form >
                  <table className='table table-hover'>
                    <thead>
                      ...
                      {
                        brands == null && <tr><td colSpan='4'>No Brands Found</td></tr>
                      }
                      <tr>
                        <th width="100">ID</th>
                        <th width="400">Brand Name</th>
                        ...
                        brands && brands.map(brand => {
                          return (
                            ...
                            <td>
                                                           ...
                                                           <Link onClick={() => deleteBrands(brand.id)} className='text-danger ms-2'>
